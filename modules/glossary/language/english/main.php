...
define('_MD_GLOSSARY_EDITK', "Edit");
define('_MD_GLOSSARY_DELETE', "Delete");
...
// テーブル：カテゴリ
// --------------------------------------------------------
define('_MD_GLOSSARY_CATEGORY', "Categories");
define('_MD_GLOSSARY_CATEGORY_ADD', "Add category");
define('_MD_GLOSSARY_CATEGORY_LIST', "Categories list");
define('_MD_GLOSSARY_CATEGORY_EDIT', "Edit category");
define('_MD_GLOSSARY_CATEGORY_EDIT_ERROR', "カテゴリの編集でエラーが発生しました。保存できません。");
define('_MD_GLOSSARY_CATEGORY_SUCCESS', "カテゴリを保存しました。");
define('_MD_GLOSSARY_CATEGORY_DELETE', "Del category");
...
define('_MD_GLOSSARY_CATEGORY_PARENTID', "サブカテゴリ");
define('_MD_GLOSSARY_CATEGORY_NAME', "Category Name");
define('_MD_GLOSSARY_CATEGORY_DESCRIPTION', "Description");
define('_MD_GLOSSARY_CATEGORY_WEIGHT', "Weight");
